...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public static class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        public CourseViewHolder(View itemView, final OnItemClickListener listener) {
            ...
            textViewName = itemView.findViewById(R.id.text_view_course_name);
            textViewDescription = itemView.findViewById(R.id.text_view_course_description);
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (listener != null) {int position = getAbsoluteAdapterPosition();
                        if (position != RecyclerView.NO_POSITION) {
