    ...
    private void fetchPosts() {
        apiService.getPosts().enqueue( new Callback<List<Post>>() {
            ...
            public void onFailure(Call<List<Post>> call, Throwable t) {
                Toast.makeText(MainActivity.this, "Error while fetching posts: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deletePost(int postId, int position) {
        apiService.deletePost(postId).enqueue(new Callback<Void>() {
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(MainActivity.this, "Error while deleting post: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}